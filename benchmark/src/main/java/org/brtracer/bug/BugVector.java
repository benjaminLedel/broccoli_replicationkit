...
public class BugVector {
	...
	public void create() throws WVToolException, IOException {
		HOME_FOLDER = BroccoliContext.getInstance().getWorkDir() + BroccoliContext.getInstance().getSeparator();
		BUG_CORPUS_FOLDER = "BugCorpus" + BroccoliContext.getInstance().getSeparator();
