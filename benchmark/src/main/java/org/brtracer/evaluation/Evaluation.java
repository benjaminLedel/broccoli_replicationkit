...
public class Evaluation {
	...
	private String workDir = BroccoliContext.getInstance().getWorkDir() + BroccoliContext.getInstance().getSeparator();
	private int fileCount = BroccoliContext.getInstance().getContextVar("FileCount");
	private int bugCount = BroccoliContext.getInstance().getContextVar("BugReportCount");
	private int originfilecount = BroccoliContext.getInstance().getContextVar("OriginFileCount");
	...
	private String outputFile = BroccoliContext.getInstance().getOutputFile();
	private float alpha = 0.3f;
	private String lineSparator = BroccoliContext.getInstance().getLineSeparator();
	...
	public void evaluate(boolean writeAll) throws IOException {
