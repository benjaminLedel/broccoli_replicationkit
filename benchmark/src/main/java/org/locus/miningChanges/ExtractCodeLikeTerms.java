...
//		System.out.println(clts.toString());
	...
	public HashMap<String,Integer> extractCodeLikeTerms() {
		String filename = de.broccoli.context.BroccoliContext.getInstance().getWorkDir()  + File.separator + "codeLikeTerms.txt";
	...
	private HashMap<String,Integer> createCodeLikeTerms() {
		...
		List<String> lines = FileListUnderDirectory.getFileListUnder(org.locus.main.Main.getInstance().sourceDir, ".java");
