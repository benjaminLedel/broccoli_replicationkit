...
import org.locus.utils.ReadFileToList;
...
public class ObtainVSMScore {
	...
	public HashMap<String, List<String>> bugTermList;
	public List<Bug> bugs;
	public HashMap<String,List<Integer>> bugCLTIndex;
...
//			System.out.println(line);
	...
	public void loadBugFiles() {
		...
		bugTermList = new HashMap<String, List<String>>();
...
//			if (!semanticHids.contains(hunk)) continue;
	...
	public HashMap<String, HashMap<String, Double>> getResults(boolean isChangeLevel) {
		...
		HashMap<String, HashMap<String, Double>> bugChangeResults = new HashMap<String, HashMap<String,Double>>();
		...
		double lambda = Main.getInstance().lambda;

		List<Pair<Integer, Long>> bugRank = new ArrayList<Pair<Integer, Long>>();
		for (int i = 0; i < bugs.size(); i++)
			bugRank.add(new Pair<Integer,Long>(i, bugs.get(i).getOpenDate().getTime()));
	...
	public HashMap<String, HashMap<String, Double>> obtainSimilarity(boolean isChangeLevel) {
		loadBugFiles();
