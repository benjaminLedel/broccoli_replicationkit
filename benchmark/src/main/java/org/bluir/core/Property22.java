...
public class Property22 {
	 ...
	 * Singleton functions
	 */
	private static Property22 p = null;
	...
	public static void createInstance(String projectName, String bugFilePath, String sourceCodeDir, String workDir, float alpha, String outputFile, String indriPath){
		if (p == null)
			p = new Property22(projectName, bugFilePath, sourceCodeDir, workDir, alpha, outputFile, indriPath);
	}

	public static Property22 getInstance() {
		return p;
	}

	private Property22(String projectName, String bugFilePath, String sourceCodeDir, String workDir, float alpha, String outputFile, String indriPath) {
