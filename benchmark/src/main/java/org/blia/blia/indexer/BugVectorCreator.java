...
import org.blia.db.AnalysisValue;
...
public class BugVectorCreator {
	private String HOME_FOLDER = (new StringBuilder(String.valueOf(Property.getInstance().WORK_DIR))).append(Property.getInstance().separator).toString();
    private String BUG_CORPUS_FOLDER = (new StringBuilder("BugCorpus")).append(Property.getInstance().separator).toString();


	public void create() throws Exception {
		HOME_FOLDER = (new StringBuilder(String.valueOf(Property.getInstance().WORK_DIR))).append(Property.getInstance().separator).toString();
		String BUG_CORPUS_FOLDER = (new StringBuilder("BugCorpus")).append(Property.getInstance().separator).toString();
