...
public class Similarity {
	...
	private String Separator = BroccoliContext.getInstance().getSeparator();
	public int fileCount = BroccoliContext.getInstance().getContextVar("FileCount");
	public int codeTermCount = BroccoliContext.getInstance().getContextVar("WordCount");
	...
	public void compute() throws IOException {
		...
		while ((idLine = readerId.readLine()) != null) {
			...
			for (String word : wordTable.keySet()) {
				Integer id = wordIdTable.get(word);
				if (id == null) continue;	//code word�� �������� �ʴ� �ܾ�� ����... (�ణ �̻������µ� �������ǰ�...)
